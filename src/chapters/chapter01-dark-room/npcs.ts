...
export const npcs: NPCDef[] = [
  ...
  // =========================================================================
  {
    ...
    dialogueTree: [
      ...
      // --- check in (after acceptance, rel 2-4) ---
      {
        id: 'stranger_checkIn',
        ...
        options: [
          ...
          {
            id: 'ask_cold_again',
            text: 'does the cold still bother you?',
            nextNodeId: 'stranger_coldStill',
            effects: [{ type: 'relationship', npcId: 'stranger', amount: 1 }],
          },
        ],
      },
      ...
      {
        id: 'stranger_coldStill',
        text: '"always." they press their palms together. "but it\'s different now. there\'s something to come back to. the fire. the room." a pause. "you."',
        options: [
          {
            id: 'end_coldStill',
            text: 'you\'re one of us now.',
            nextNodeId: 'stranger_silence',
            effects: [{ type: 'relationship', npcId: 'stranger', amount: 1 }],
          },
        ],
      ...
      // --- settlement phase reaction ---
      {
        ...
        condition: 'flag.strangerAccepted == true && phase == "settlement" && npc.stranger.relationship >= 3 && npc.stranger.relationship < 5',
        options: [
          {
            id: 'it_matters',
            text: 'it does matter.',
      ...
      // --- memory recovery (rel 3-5) ---
      {
        ...
        condition: 'flag.strangerAccepted == true && npc.stranger.relationship >= 3 && npc.stranger.relationship < 5 && flag.strangerMemory1 != true',
        options: [
          {
            id: 'ask_precise',
            text: 'like what?',
      ...
      // --- nightmare dialogue (rel 4+, ticks > 500) ---
      {
      ...
      // --- higher relationship dialogues (rel 5+) ---
      {
        id: 'stranger_deep',
        ...
        condition: 'npc.stranger.relationship >= 5 && quest.mainDiscover.step >= 1',
        options: [
          {
            id: 'ask_facility',
  ...
  // =========================================================================
  {
    ...
    dialogueTree: [
      ...
      // --- technical talk about buildings (rel 3+, builder accepted) ---
      {
        ...
        condition: 'flag.builderAccepted == true && npc.builder.relationship >= 3 && npc.builder.relationship < 6 && flag.builderTechnical != true',
        options: [
          {
            id: 'yes_tell',
            text: 'show me.',
      ...
      // --- workshop reaction ---
      {
        ...
        text: 'the builder stands in the workshop doorway. runs her hand along the frame. "proper joints. good timber." she turns to you. "this is where real work happens. i can see the grain of the wood. i can think."',
      ...
      // --- blueprint quest dialogue (rel 5+, mainDiscover step 2+) ---
      {
        ...
        condition: 'npc.builder.relationship >= 5 && quest.mainDiscover.step >= 2',
        options: [
          {
            id: 'ask_blueprint',
            text: 'leaving where?',
      ...
      // --- vessel design stages (rel 6+, after blueprint) ---
      {
      ...
      // --- emotional — building vs entropy (rel 7+) ---
      {
        id: 'builder_entropy',
      ...
      // --- late-game doubts (departure phase, rel 8+) ---
      {
        id: 'builder_doubts',
  ...
  // =========================================================================
  {
    ...
    dialogueTree: [
      ...
      // --- trade routes (rel 5+) ---
      {
        ...
        condition: 'flag.cartographerAccepted == true && npc.cartographer.relationship >= 5 && flag.cartoTrade != true',
        options: [
          {
            id: 'ask_traders',
            text: 'who trades?',
      ...
      // --- deep relationship (rel 6+, mainDiscover step 3+) ---
      {
        id: 'carto_secret',
      ...
      // --- geography lore — rivers and the freeze (rel 4+) ---
      {
        id: 'carto_rivers',
      ...
      // --- beyond the map (rel 8+, late-game) ---
      {
        id: 'carto_beyond',
      ...
      // --- react to exploration progress (rel 5+, landmarks discovered) ---
      {
        id: 'carto_progress',
  ...
  // =========================================================================
  {
    ...
    dialogueTree: [
      ...
      // --- teaching dialogues — old-world history (rel 3+) ---
      {
        id: 'hermit_teaching',
      ...
      // --- philosophical conversation — cycles (rel 4+) ---
      {
      ...
      // --- memories of the old world (rel 4+) ---
      {
      ...
      // --- the bright room — deeper revelations (rel 5+) ---
      {
      ...
      // --- react to old-world artifacts (rel 4+, with item) ---
      {
        id: 'hermit_artifact',
      ...
      // --- final quest step (rel 8+, hermitMemory step 2+) ---
      {
        id: 'hermit_final',
        ...
        condition: 'npc.hermit.relationship >= 8 && quest.hermitMemory.step >= 2',
        options: [
          {
            id: 'follow_hermit',
            text: 'show me.',
      ...
      // --- farewell dialogue (if player takes hidden exit) ---
      {
        id: 'hermit_farewell',
  ...
  // =========================================================================
  {
    ...
    dialogueTree: [
      ...
      // --- tactical briefings (rel 3+, accepted) ---
      {
        id: 'scout_tactical',
      ...
      {
        id: 'scout_wolves',
        text: '"smart. patient. they don\'t attack unless they outnumber you." she sets down an arrow. "but i respect them. they survive the same way we do. together." she looks at the fire. "the alpha female — i\'ve seen her three times. she watches the village. not hunting. studying. i think she knows we\'re different from the usual prey."',
        options: [
          {
            id: 'end_wolves',
      ...
      // --- patrol member found (rel 5+, flag) ---
      {
      ...
      // --- deep relationship (rel 6+, raiderKingKnown) ---
      {
        id: 'scout_deep',
        ...
        condition: 'npc.scout.relationship >= 6 && flag.raiderKingKnown == true',
        options: [
          {
            id: 'prepare',
      ...
      // --- battle planning (rel 7+, reckoning phase) ---
      {
        id: 'scout_battlePlan',
      ...
      // --- post-victory (after boss defeated) ---
      {
      ...
      // --- stay or leave (rel 8+, departure phase) ---
      {
